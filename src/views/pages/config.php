       ...
       <form method="POST" action="<?=$base;?>/config" enctype="multipart/form-data">
          <section class="feed mt-10">
            ...
            <div class=" preview-avatar-file">
               <img src="<?=$base;?>/media/avatars/<?=$lloggedUser->avatar;?>" width="100" height="100">
            </div>
          </section>
          <section class="feed mt-10">
            ...
            <div class=" preview-avatar-file">
               <img src="<?=$base;?>/media/covers/<?=$lloggedUser->cover?>" width="300" height="100">
            </div>
          </section><br>
          <hr/>
          <section class="feed mt-10">
          ...
          <section class="feed mt-10">
              ...
              <input type="password"  class="input" name="rep_password" autocomplete="off"/>
          </section>
